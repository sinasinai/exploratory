with l as (
	...
	*
	from (
			select
			*,
			row_number() over (partition by properties_address order by properties_mostrecentissuedate::timestamp desc) as rk
			from licenses
...
p as (
	...
	*
	from (
		...
		select
		*,
		row_number() over (partition by properties_location order by properties_recording_date::timestamp desc) as rk
		from properties
...
properties_recording_date::timestamp as property_recording_date,
...
from combined
where left(properties_zip,5)
in ('19134', '19144', '19139', '19131', '19154', '19120', '19124', '19141', '19143', '19104')
