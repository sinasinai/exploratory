...
as (
	...
	combined as (
		...
		select
		*,
    p.geometry_coordinates as coordinates
		from l
  ...
  coordinates,
	properties_market_value as market_value,
	properties_opa_account_num as opa_account_number,
	properties_opa_owner as opa_owner,
	properties_licensenum as rental_license_number,
	...
	from combined
	where properties_zip != 'nan'
	order by properties_zip, properties_address
);

select * from renters order by zip_code, address;
